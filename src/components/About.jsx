...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative bg-gray-800 rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 lg:p-10 text-left leading-relaxed
      ...
      >
        ...
        <div className="relative z-10 space-y-6">
          <p className="text-base sm:text-lg text-gray-300">{t("about.paragraph1")}</p>
          <p className="text-base sm:text-lg text-gray-300">{t("about.paragraph2")}</p>
