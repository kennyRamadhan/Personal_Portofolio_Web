...
export default function Header() {
  ...
  const sections = [
    ...
    { id: "portfolio", label: "Frameworks" },
    { id: "language", label: "Programming" },
      ...
      <nav className="flex items-center justify-between relative">
        ...
        <div className="relative ml-auto">
          ...
          <div className="hidden md:block relative">
            ...
            {desktopOpen && (
              <div
                className="absolute right-0 mt-2 bg-primary rounded-lg shadow-lg flex flex-col p-3 space-y-2 min-w-[150px]
          ...
          <div className="md:hidden relative">
            ...
            {isOpen && (
              <div
                className="absolute right-0 top-full mt-2 w-64 bg-primary rounded-b-lg shadow-lg flex flex-col space-y-2 p-4 z-50 transition-all duration-300"
              >
                {sections.map(sec => (
                  <a
                    key={sec.id}
